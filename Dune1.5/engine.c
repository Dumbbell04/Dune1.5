...
void init(void) {
    ...
    // 테두리 그리기
    set_color(0xF0); // 흰 배경(7), 검은 글자(0)
    draw_rect(0xF0, 0, 1, MAP_WIDTH, 1, '#');      // 상단
    draw_rect(0xF0, 0, MAP_HEIGHT - 1, MAP_WIDTH, 1, '#'); // 하단
    draw_rect(0xF0, 0, 1, 1, MAP_HEIGHT - 1, '#'); // 좌측
    draw_rect(0xF0, MAP_WIDTH - 1, 1, 1, MAP_HEIGHT - 2, '#'); // 우측
